...
export type FieldProcessorData = ValuePresenceData<'field', FieldData>;
...
const field = (key: string, newKey: string, presence: FieldPresence.FieldPresenceTypes, prop: Processor): FieldProcessorData => ({ discriminator: 'field', data: { key, newKey, presence, prop }});
